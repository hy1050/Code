...
def info():
    tmp = OrderedDict()
    tmp['description'] = 'VietNam Traffic Sign Recognition (VNTSR)'
    tmp['url'] = 'https://benchmark.ini.rub.de/'
    tmp['version'] = '1.0'
    tmp['year'] = '2024'
    tmp['contributor'] = 'Nguyen Anh Huy - 18146022'
...
if __name__ == '__main__':
    ...
    output_fn = 'vntsr_train.json' if args.mode == 'train' else 'vntsr_test.json'
